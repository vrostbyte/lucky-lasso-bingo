        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <div className="flex justify-between items-start mb-4">
            <div>
              ...
              <p className="text-deep-sage mb-1">
                <span className="font-medium">Pattern:</span> {game.patternName}
              </p>
              <p className="text-deep-sage mb-1">
                <span className="font-medium">Prize:</span> {game.prize}
              </p>
              <p className="text-deep-sage mb-1">
                <span className="font-medium">Verification Code:</span> {game.verificationCode}
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            <div className="bg-lilac bg-opacity-20 p-3 rounded-lg">
              ...
              <p className="text-deep-sage font-medium">
                {game.createdAt?.toLocaleString() || 'Unknown'}
              </p>
            </div>
            ...
            <div className="bg-lilac bg-opacity-20 p-3 rounded-lg">
              ...
              <p className="text-deep-sage font-medium">
                {game.startTime?.toLocaleString() || 'Not started'}
              </p>
            </div>
            ...
            <div className="bg-lilac bg-opacity-20 p-3 rounded-lg">
              ...
              <p className="text-deep-sage font-medium">
                {game.endTime?.toLocaleString() || 'Not ended'}
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-lilac bg-opacity-20 p-3 rounded-lg">
              ...
              <p className="text-deep-sage font-medium">
                {game.drawnBalls?.length > 0 ? game.drawnBalls[game.drawnBalls.length - 1] : 'None'}
              </p>
            </div>
          </div>
            ...
            <div className="mt-6 p-4 border border-olivine rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-3">
                ...
                <div>
                  ...
                  <p className="text-deep-sage font-medium">
                    ${game.actualPayoutPerWinner?.toFixed(2) || game.payoutPerWinner || '0.00'}
                  </p>
                </div>
              </div>
              
              {game.calculatedPayoutPerWinner && game.actualPayoutPerWinner && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3 mt-2">
                  <div>
                    <p className="text-sm text-deep-sage">Calculated Payout</p>
                    <p className="text-deep-sage font-medium">
                      ${game.calculatedPayoutPerWinner.toFixed(2)}
                    </p>
                  </div>
                  
                  <div>
                    <p className="text-sm text-deep-sage">Actual Payout (Rounded Up)</p>
                    <p className="text-deep-sage font-medium">
                      ${game.actualPayoutPerWinner.toFixed(2)}
                    </p>
                  </div>
                </div>
              )}
          ...
          {!game.drawnBalls || game.drawnBalls.length === 0 ? (
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Balls are shown in the order they were drawn (first to last).
              </p>
            </div>
          )}
